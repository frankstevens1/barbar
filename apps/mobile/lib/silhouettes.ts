...
export const PRESET_SILHOUETTES: NamedSilhouette[] = [
  // 1. Historic skyline (church steeples & domes)
  {
  ...
  // 2. Industrial complex (smokestacks & warehouses)
  {
  ...
  // 3. Futuristic spires (pointed, irregular heights)
  {
  ...
  // 5. Forest edge (pointed tree tops)
  {
  ...
  // 9. Mixed skyline (residential blocks & water tower)
  {
